<template>
    <div class="enter-screen wrapper">
        ...
        <div class="enter-screen__links">
            <button onclick="document.location='#/sign-up'" class="enter-screen__link-signup">Sign Up</button>
            <div class="enter-screen__link-signin">
...
<style lang="scss" src="./enter-screen.scss"></style>